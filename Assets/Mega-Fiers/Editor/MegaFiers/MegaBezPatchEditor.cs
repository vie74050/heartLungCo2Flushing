...
#if UNITY_5_6 || UNITY_2017 || UNITY_2018 || UNITY_2019 || UNITY_2020 || UNITY_2021 || UNITY_2022 || UNITY_2023_1_OR_NEWER
				mod.p11 = Handles.FreeMoveHandle(p11, mod.handlesize, mod.snap, Handles.SphereHandleCap);
				mod.p14 = Handles.FreeMoveHandle(p14, mod.handlesize, mod.snap, Handles.SphereHandleCap);
				mod.p41 = Handles.FreeMoveHandle(p41, mod.handlesize, mod.snap, Handles.SphereHandleCap);
				mod.p44 = Handles.FreeMoveHandle(p44, mod.handlesize, mod.snap, Handles.SphereHandleCap);

				if ( !mod.align )
				{
					mod.p12 = Handles.FreeMoveHandle(p12, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p13 = Handles.FreeMoveHandle(p13, mod.handlesize, mod.snap, Handles.SphereHandleCap);

					mod.p21 = Handles.FreeMoveHandle(p21, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p22 = Handles.FreeMoveHandle(p22, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p23 = Handles.FreeMoveHandle(p23, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p24 = Handles.FreeMoveHandle(p24, mod.handlesize, mod.snap, Handles.SphereHandleCap);

					mod.p31 = Handles.FreeMoveHandle(p31, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p32 = Handles.FreeMoveHandle(p32, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p33 = Handles.FreeMoveHandle(p33, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p34 = Handles.FreeMoveHandle(p34, mod.handlesize, mod.snap, Handles.SphereHandleCap);

					mod.p42 = Handles.FreeMoveHandle(p42, mod.handlesize, mod.snap, Handles.SphereHandleCap);
					mod.p43 = Handles.FreeMoveHandle(p43, mod.handlesize, mod.snap, Handles.SphereHandleCap);
				}
#else
